! function(e) {
    ...
    "Cw/M": function(e, t) {
        ...
        function a(e, t, n, r) {
            if (t.hide(), n.hide(), "" !== r.department) {
                ...
                t.show(), "" !== r.location ? t.find(`[data-location=${r.location}]`).show() : t.find(".positions__single").show()
            } else {
                let t = n;
                "" !== r.location && (t = e.find(`[data-location=${r.location}]`)), t.show(), t.parent(".positions__department").show()
            }
            addResizeEvent(s), c(), $(window).scroll(c)
        }

        function s() {
            r = window.innerHeight || document.documentElement.clientHeight, n = window.innerWidth || document.documentElement.clientWidth;
            const e = $(".offices__slider");
            n <= 870 && !e.hasClass("slick-slider") && (e.find(".office").addClass("fade-elements__visible"), e.slick({
                speed: 300,
                dots: !0,
                variableWidth: !0,
                centerMode: !0,
        ...
        $(() => {
            ! function() {
                ...
                (function(e, t) {
                    if ($(e).length) {
                        const r = $(e),
                            i = new Instafeed({
                                ...
                                after() {
                                    var e;
                                    e = $(".photos-slider"), $(e).length && $(".photos-slider").slick({
                                        infinite: !0,
                                        speed: 1e3,
                ...
                })("#instagram-content", 20), s(), i = $(".main-header"), $(".hamburger").click(e => {
                    ...
                    function(e, t, n, r) {
                        ...
                        s && (r.location = s, e.find(`.filter-select [value="${s}"]`).attr("selected", !0)), c && (r.department = c, e.find(`.filter-select [value="${c}"]`).attr("selected", !0)), a(e, t, n, r)
                    }(r, c, l, u), $(".search__item__icon").length && $(".search__item__icon").each(function(n) {
                        const r = `icon__${n}`;
                ...
                $(".search__item").length && o.find("[data-country]").on("click", function() {
                    ...
                    u.location = e, r.find(`.filter-select [value="${e}"]`).attr("selected", !0), a(r, c, l, u)
                });
    ...
    oCYn: function(e, t, n) {
        ...
        (function(e, n) {
            ...
            var Ce = function(e) {
                var t;
                this.value = e, this.dep = new le, this.vmCount = 0, U(e, "__ob__", this), Array.isArray(e) ? (V ? (t = _e, e.__proto__ = t) : function(e, t, n) {
            ...
            function xe(e, t) {
                var n;
                if (c(e) && !(e instanceof pe)) return b(e, "__ob__") && e.__ob__ instanceof Ce ? n = e.__ob__ : $e && !ne() && (Array.isArray(e) || u(e)) && Object.isExtensible(e) && !e._isVue && (n = new Ce(e)), t && n && n.vmCount++, n
            }
            ...
            var Ke = !1;
            if (void 0 !== n && ie(n)) Ve = function() {
                n(qe)
            };
            else if ("undefined" == typeof MessageChannel || !ie(MessageChannel) && "[object MessageChannelConstructor]" !== MessageChannel.toString()) Ve = function() {
                setTimeout(qe, 0)
            };
            else {
                var Je = new MessageChannel,
                    Xe = Je.port2;
                Je.port1.onmessage = qe, Ve = function() {
                    Xe.postMessage(1)
                }
            }
            ...
            function Ze(e, t) {
                ...
                if (Ge.push(function() {
                    ...
                    }), We || (We = !0, Ke ? Ve() : ze()), !e && "undefined" != typeof Promise) return new Promise(function(e) {
                    n = e
                })
            }
            var Qe = new oe;
            ...
            function it(e, t, n, r, o, s) {
                var c, l, u, f;
                for (c in e) l = e[c], u = t[c], f = nt(c), i(l) || (i(u) ? (i(l.fns) && (l = e[c] = rt(l)), a(f.once) && (l = e[c] = o(f.name, l, f.capture)), n(f.name, l, f.capture, f.passive, f.params)) : l !== u && (u.fns = l, e[c] = u));
            ...
            function st(e) {
                return s(e) ? [me(e)] : Array.isArray(e) ? function e(t, n) {
                    var r = [];
                    var c, l, u, f;
                    for (c = 0; c < t.length; c++) i(l = t[c]) || "boolean" == typeof l || (u = r.length - 1, f = r[u], Array.isArray(l) ? l.length > 0 && (ct((l = e(l, (n || "") + "_" + c))[0]) && ct(f) && (r[u] = me(f.text + l[0].text), l.shift()), r.push.apply(r, l)) : s(l) ? ct(f) ? r[u] = me(f.text + l) : "" !== l && r.push(me(l)) : ct(l) && ct(f) ? r[u] = me(f.text + l.text) : (a(t._isVList) && o(l.tag) && i(l.key) && o(n) && (l.key = "__vlist" + n + "_" + c + "__"), r.push(l)));
                    return r
                }(e) : void 0
            }
            ...
            function Et() {
                var e, t;
                for (Tt = !0, xt.sort(function(e, t) {
                        return e.id - t.id
                    }), Ot = 0; Ot < xt.length; Ot++)(e = xt[Ot]).before && e.before(), t = e.id, At[t] = null, e.run();
                var n = kt.slice(),
                    r = xt.slice();
                Ot = xt.length = kt.length = 0, At = {}, St = Tt = !1,
                    function(e) {
                    ...
                    }(r), re && B.devtools && re.emit("flush")
            }
            var Lt = 0,
                jt = function(e, t, n, r, i) {
                    this.vm = e, i && (e._watcher = this), e._watchers.push(this), r ? (this.deep = !!r.deep, this.user = !!r.user, this.lazy = !!r.lazy, this.sync = !!r.sync, this.before = r.before) : this.deep = this.user = this.lazy = this.sync = !1, this.cb = n, this.id = ++Lt, this.active = !0, this.dirty = this.lazy, this.deps = [], this.newDeps = [], this.depIds = new oe, this.newDepIds = new oe, this.expression = "", "function" == typeof t ? this.getter = t : (this.getter = function(e) {
                        if (!H.test(e)) {
                            var t = e.split(".");
                            return function(e) {
                        ...
                        if (i(e.cid) && void 0 === (e = function(e, t, n) {
                                ...
                                if (!o(e.contexts)) {
                                    var r = e.contexts = [n],
                                        ...
                                        d = e(u, f);
                                    return c(d) && ("function" == typeof d.then ? i(e.resolved) && d.then(u, f) : o(d.component) && "function" == typeof d.component.then && (d.component.then(u, f), o(d.error) && (e.errorComp = lt(d.error, t)), o(d.loading) && (e.loadingComp = lt(d.loading, t), 0 === d.delay ? e.loading = !0 : setTimeout(function() {
            ...
            function un(e, t, n, r, l, u) {
                return (Array.isArray(n) || s(n)) && (l = r, r = n, n = void 0), a(u) && (l = ln),
                    function(e, t, n, r, s) {
                        ...
                        if ("string" == typeof t) {
                            var f;
                            u = e.$vnode && e.$vnode.ns || B.getTagNamespace(t), l = B.isReservedTag(t) ? new pe(B.parsePlatformTagName(t), n, r, void 0, void 0, e) : n && n.pre || !o(f = Me(e.$options, "components", t)) ? new pe(t, n, r, void 0, void 0, e) : an(f, n, e, r, t)
                        } else l = an(t, n, e, r);
            ...
            function _n(e, t, n, r) {
                ...
                e.prototype._init = function(e) {
                    ...
                    t._uid = fn++, t._isVue = !0, e && e._isComponent ? function(e, t) {
                        ...
                        }(t, e) : t.$options = Ne(dn(t.constructor), e || {}, t), t._renderProxy = t, t._self = t,
                        function(e) {
                            var t = e.$options,
                                n = t.parent;
                            if (n && !t.abstract) {
            ...
            ! function(e) {
                ...
                Object.defineProperty(e, "config", t), e.util = {
                        ...
                        mergeOptions: Ne,
                        defineReactive: ke
                    }, e.set = Ae, e.delete = Se, e.nextTick = Ze, e.options = Object.create(null), F.forEach(function(t) {
                        e.options[t + "s"] = Object.create(null)
                    }), e.options._base = e, O(e.options.components, $n),
                    function(e) {
                        e.use = function(e) {
            ...
            function ir(e, t, n) {
                e.tagName.indexOf("-") > -1 ? or(e, t, n) : An(t) ? En(n) ? e.removeAttribute(t) : (n = "allowfullscreen" === t && "EMBED" === e.tagName ? "true" : t, e.setAttribute(t, n)) : kn(t) ? e.setAttribute(t, En(n) || "false" === n ? "false" : "true") : Tn(t) ? En(n) ? e.removeAttributeNS(Sn, On(t)) : e.setAttributeNS(Sn, t, n) : or(e, t, n)
            }
            ...
            function Br(e, t) {
                if (!i(e.data.on) || !i(t.data.on)) {
                    ...
                    Nr = t.elm,
                        ...
                        }(n), it(n, r, Fr, Rr, Pr, t.context), Nr = void 0
                }
            }
            var Ur = {
                create: Br,
            ...
            function ei(e, t) {
                ...
                if (!(i(n.staticStyle) && i(n.style) && i(r.staticStyle) && i(r.style))) {
                    ...
                    var p = function(e, t) {
                        var n, r = {};
                        if (t)
                            for (var i = e; i.componentInstance;)(i = i.componentInstance._vnode) && i.data && (n = Wr(i.data)) && O(r, n);
                        (n = Wr(e.data)) && O(r, n);
            ...
            function bi(e, t) {
                var n, r = window.getComputedStyle(e),
                    ...
                    u = 0,
                    f = 0;
                return t === ci ? a > 0 && (n = ci, u = a, f = o.length) : t === li ? l > 0 && (n = li, u = l, f = c.length) : f = (n = (u = Math.max(a, l)) > 0 ? a > l ? ci : li : null) ? n === ci ? o.length : c.length : 0, {
                    type: n,
                    timeout: u,
                    propCount: f,
            ...
            function Ci(e, t) {
                ...
                if (!i(r) && !o(n._enterCb) && 1 === n.nodeType) {
                    ...
                    if (!S || $ || "" === $) {
                        ...
                        }), L && L(n), P && (mi(n, T), mi(n, O), hi(function() {
            ...
            function xi(e, t) {
                ...
                function C() {
                    w.cancelled || (!e.data.show && n.parentNode && ((n.parentNode._pending || (n.parentNode._pending = {}))[e.key] = e), d && d(n), _ && (mi(n, l), mi(n, f), hi(function() {
            ...
            var Ti = function(e) {
                ...
                function f(e, t, n, i, s, c, u) {
                    if (o(e.elm) && o(c) && (e = c[u] = ye(e)), e.isRootInsert = !s, ! function(e, t, n, i) {
                            var s = e.data;
                            if (o(s)) {
                    ...
                    if (e !== t) {
                        ...
                        if (a(e.isAsyncPlaceholder)) o(t.asyncFactory.resolved) ? S(e.elm, t, n) : t.isAsyncPlaceholder = !0;
                            ...
                            i(t.text) ? o(h) && o(y) ? h !== y && function(e, t, n, r, a) {
                                for (var s, c, u, d = 0, p = 0, v = t.length - 1, h = t[0], m = t[v], y = n.length - 1, g = n[0], b = n[y], w = !a; d <= v && p <= y;) i(h) ? h = t[++d] : i(m) ? m = t[--v] : Kn(h, g) ? (x(h, g, r, n, p), h = t[++d], g = n[++p]) : Kn(m, b) ? (x(m, b, r, n, y), m = t[--v], b = n[--y]) : Kn(h, b) ? (x(h, b, r, n, y), w && l.insertBefore(e, h.elm, l.nextSibling(m.elm)), h = t[++d], b = n[--y]) : Kn(m, g) ? (x(m, g, r, n, p), w && l.insertBefore(e, m.elm, h.elm), m = t[--v], g = n[++p]) : (i(s) && (s = Jn(t, d, v)), i(c = o(g.key) ? s[g.key] : C(g, t, d, v)) ? f(g, r, e, h.elm, !1, n, p) : Kn(u = t[c], g) ? (x(u, g, r, n, p), t[c] = void 0, w && l.insertBefore(e, u.elm, h.elm)) : f(g, r, e, h.elm, !1, n, p), g = n[++p]);
                                d > v ? _(e, i(n[y + 1]) ? null : n[y + 1].elm, n, p, y, r) : p > y && $(0, t, d, v)
                            }(d, h, y, n, u) : o(y) ? (o(e.text) && l.setTextContent(d, ""), _(d, null, y, 0, y.length - 1, n)) : o(h) ? $(0, h, 0, h.length - 1) : o(e.text) && l.setTextContent(d, "") : e.text !== t.text && l.setTextContent(d, t.text), o(v) && o(p = v.hook) && o(p = p.postpatch) && p(e, t)
                        }
                    }
                }
            ...
            var Oi = {
                inserted: function(e, t, n, r) {
                    ...
                    }) : Ei(e, t, n.context), e._vOptions = [].map.call(e.options, Ii)) : ("textarea" === n.tag || Un(e.type)) && (e._vModifiers = t.modifiers, t.modifiers.lazy || (e.addEventListener("compositionstart", Ni), e.addEventListener("compositionend", Mi), e.addEventListener("change", Mi), X && (e.vmodel = !0)))
                },
            ...
            function Ei(e, t, n) {
                Li(e, t, n), (J || Y) && setTimeout(function() {
                    Li(e, t, n)
                }, 0)
            }
                    ...
                    render: function(e) {
                        ...
                        if (n && (n = n.filter(zi)).length) {
                            ...
                            var c = (o.data || (o.data = {})).transition = Ui(this),
                                l = this._vnode,
                                u = Bi(l);
                            if (o.data.directives && o.data.directives.some(Vi) && (o.data.show = !0), u && u.data && ! function(e, t) {
                                ...
                                if ("in-out" === r) {
                                    ...
                                    ot(c, "afterEnter", p), ot(c, "enterCancelled", p), ot(f, "delayLeave", function(e) {
                                        d = e
                                    })
                                }
                            }
            ...
            var Xi = {
                ...
                TransitionGroup: {
                    ...
                    updated: function() {
                        ...
                        e.length && this.hasMove(e[0].elm, t) && (e.forEach(qi), e.forEach(Ki), e.forEach(Ji), this._reflow = document.body.offsetHeight, e.forEach(function(e) {
                            if (e.data.moved) {
                                var n = e.elm,
                                    r = n.style;
            ...
            vn.config.mustUseProp = xn, vn.config.isReservedTag = Fn, vn.config.isReservedAttr = wn, vn.config.getTagNamespace = Rn, vn.config.isUnknownElement = function(e) {
                if (!G) return !0;
                if (Fn(e)) return !1;
            ...
            }, O(vn.options.directives, Fi), O(vn.options.components, Xi), vn.prototype.__patch__ = G ? Ti : L, vn.prototype.$mount = function(e, t) {
                return function(e, t, n) {
                    var r;
                    return e.$el = t, e.$options.render || (e.$options.render = he), Ct(e, "beforeMount"), r = function() {
            ...
            var ko, Ao, So, To, Oo, Eo, Lo, jo, Io = /^@|^v-on:/,
                No = /^v-|^@|^:/,
            ...
            function zo(e, t) {
                ko = t.warn || gr, Eo = t.isPreTag || j, Lo = t.mustUseProp || j, jo = t.getTagNamespace || j, So = _r(t.modules, "transformNode"), To = _r(t.modules, "preTransformNode"), Oo = _r(t.modules, "postTransformNode"), Ao = t.delimiters;
                var n, r, i = [],
                ...
                return function(e, t) {
                    ...
                    start: function(e, o, l) {
                        ...
                        if (a || (! function(e) {
                            ...
                            }(d), d.pre && (a = !0)), Eo(d.tag) && (s = !0), a ? function(e) {
                            ...
                            }(d), Vo(d, t)), n ? i.length || n.if && (d.elseif || d.else) && (v(), Wo(n, {
                                exp: d.elseif,
                                block: d
                            })) : (n = d, v()), r && !d.forbidden)
                    ...
                    chars: function(e) {
                        if (r && (!J || "textarea" !== r.tag || r.attrsMap.placeholder !== e)) {
                            ...
                            if (e = s || e.trim() ? "script" === (t = r).tag || "style" === t.tag ? e : Uo(e) : o && i.length ? " " : "") !a && " " !== e && (n = function(e, t) {
                                var n = t ? Qi(t) : Yi;
                                if (n.test(e)) {
            ...
            function Vo(e, t) {
                ...
                }(e), e.plain = !e.key && !e.attrsList.length, (r = kr(n = e, "ref")) && (n.ref = r, n.refInFor = function(e) {
                        for (var t = e; t;) {
                ...
                ! function(e) {
                    ...
                    for (t = 0, n = c.length; t < n; t++) {
                        if (r = i = c[t].name, o = c[t].value, No.test(r))
                            if (e.hasBindings = !0, (a = qo(r)) && (r = r.replace(Bo, "")), Ro.test(r)) r = r.replace(Ro, ""), o = mr(o), s = !1, a && (a.prop && (s = !0, "innerHtml" === (r = C(r)) && (r = "innerHTML")), a.camel && (r = C(r)), a.sync && xr(e, "update:" + C(r), Tr(o, "$event"))), s || !e.component && Lo(e.tag, e.attrsMap.type, r) ? br(e, r, o) : $r(e, r, o);
                    ...
                    if ("input" === e.tag) {
                        ...
                        if ((r[":type"] || r["v-bind:type"]) && (n = kr(e, "type")), r.type || n || !r["v-bind"] || (n = "(" + r["v-bind"] + ").type"), n) {
                            var i = Ar(e, "v-if", !0),
                                ...
                                s = Ar(e, "v-else-if", !0),
                                c = Yo(e);
                            Go(c), wr(c, "type", "checkbox"), Vo(c, t), c.processed = !0, c.if = "(" + n + ")==='checkbox'" + o, Wo(c, {
                                exp: c.if,
                                block: c
                            });
                            var l = Yo(e);
                            Ar(l, "v-for", !0), wr(l, "type", "radio"), Vo(l, t), Wo(c, {
                                exp: "(" + n + ")==='radio'" + o,
                                block: l
                            });
                            var u = Yo(e);
                            return Ar(u, "v-for", !0), wr(u, ":type", n), Vo(u, t), Wo(c, {
                                exp: i,
                                block: u
                    ...
                    directives: {
                        model: function(e, t, n) {
                            ...
                            if ("select" === o) ! function(e, t, n) {
                                ...
                                br(e, "checked", "Array.isArray(" + t + ")?_i(" + t + "," + i + ")>-1" + ("true" === o ? ":(" + t + ")" : ":_q(" + t + "," + o + ")")), xr(e, "change", "var $$a=" + t + ",$$el=$event.target,$$c=$$el.checked?(" + o + "):(" + a + ");if(Array.isArray($$a)){var $$v=" + (r ? "_n(" + i + ")" : i) + ",$$i=_i($$a,$$v);if($$el.checked){$$i<0&&(" + Tr(t, "$$a.concat([$$v])") + ")}else{$$i>-1&&(" + Tr(t, "$$a.slice(0,$$i).concat($$a.slice($$i+1))") + ")}}else{" + Tr(t, "$$c") + "}", null, !0)
                            }(e, r, i);
            ...
            function ra(e, t) {
                e && (Qo = na(t.staticKeys || ""), ea = t.isReservedTag || j, function e(t) {
                    t.static = function(e) {
            ...
            function ba(e, t) {
                ...
                if (e.attrs && (n += "attrs:{" + ka(e.attrs) + "},"), e.props && (n += "domProps:{" + ka(e.props) + "},"), e.events && (n += ua(e.events, !1) + ","), e.nativeEvents && (n += ua(e.nativeEvents, !0) + ","), e.slotTarget && !e.slotScope && (n += "slot:" + e.slotTarget + ","), e.scopedSlots && (n += function(e, t) {
    ...
    qr4S: function(e, t, n) {
        ...
        var o = function(e, t, n, r, i, o, a, s) {
            ...
            methods: {
                ...
                setChoice(e) {
                    ...
                    ["scene19", "scene20", "scene21", "scene22"].indexOf(this.scene.choice1) > -1 ? (this.lastScene = !0, this.setNextSceneData(e), setTimeout(() => {
                        "left" === e ? this.src = this.choice1 : "right" === e && (this.src = this.choice2)
                    }, 3e3)) : (this.setNextSceneData(e), setTimeout(() => {
                ...
                getExt() {
                    let e, t = ["video/mp4", "video/mov", "video/webm"],
                        n = this.$refs.videoGame;
                    navigator.vendor.indexOf("Apple") >= 0 && (this.safari = !0), navigator.userAgent.toLowerCase().indexOf("firefox") > -1 ? e = "mp4" : t.forEach(function(t, r) {
                ...
                prepareFile(e, t) {
                    ...
                    return new Promise(function(e, t) {
                        ...
                        (a = new XMLHttpRequest).responseType = "blob", a.open("GET", o, !0), a.onload = function() {
                            if (200 === a.status) {
                                ...
                                t.onload = function(t) {
                                    ...
                                    let o = null,
                                        a = null;
                                    o = new Uint8Array(i), a = new Blob([o], {
                                        type: "video/" + n.ext
                                    }), this.url = URL.createObjectURL(a), e(this.url)
                                }
                            }
                        }, a.send()
                    })
                ...
                bufferVideo(e) {
                    ...
                    this.getNextSceneUrl().then(function(e) {
                        let n = e;
                        !0 === t.initial && (t.generateBlob(n, null).then(function(e) {}), t.initial = !1), !0 === t.isChoiceEnded ? !1 === t.lastScene && t.prepareFile(null, "choice1").then(function(e) {
                ...
                asyncBuffer(e, t) {
                    ...
                    let r = e,
                        i = t;
                    return new Promise(function(e, t) {
                        n.xhr = new XMLHttpRequest, n.xhr.responseType = "blob", n.xhr.open("GET", r, !0), n.xhr.onload = function() {
                            200 === n.xhr.status ? e({
                ...
                generateBlob(e, t) {
                    ...
                    return new Promise(function(r, i) {
                        !0 === n.isChoiceEnded ? "choice1" === t ? (n.choice1 = e, n.srcsBuffered[0] = e, r()) : "choice2" === t && (n.choice2 = e, n.srcsBuffered[1] = e, r()) : !1 === n.isChoiceEnded && !0 === n.isChoice ? (n.srcsBuffered[0] = e, r()) : (n.srcsBuffered[0] = e, n.src = n.srcsBuffered[0], n.isChoice = !0, n.getNextSceneUrl(!0).then(function(e) {
                            r()
                        }))
                    })
                },
                playEvent() {
                    void 0 !== this.playPromise && (this.$refs.videoGame.play(), this.playPromise.then(e => {
                        !0 === this.initial ? this.bufferVideo(!1) : this.isChoiceEnded ? (this.bufferVideo(), this.setNextSceneData(this.choice), this.isChoice = !1, this.currentScene = null, this.isChoiceEnded = !0) : this.isChoice ? !1 === this.lastScene && (this.currentScene = this.this.$refs.videoGame.oncanplay = (() => {
                    ...
                    if (!1 === this.lastScene)
                        if (this.isChoice ? this.isChoice = !1 : this.isChoice = !0, null !== this.currentScene) {
                            ...
                            null === e.scene.choice1 ? e.lastScene = !0 : this.prepareFile(this.scene.srcChoice, null).then(function(t) {
                                t.match(/blob/g) ? (e.src = t, e.isChoice = !0, e.isChoiceEnded = !0, setTimeout(function() {
                                    e.activateChoices = !0
                ...
                getNextSceneUrl(e) {
                    ...
                    return new Promise(function(n, r) {
                        ...
                        }) : !0 === t.isChoice ? (t.isChoiceEnded = !0, t.prepareFile(t.scene.srcChoice, null).then(function(e) {
                            n(e)
                ...
                setNextSceneData(e) {
                    ...
                    } else null !== this.currentScene ? (t = this.srcList[this.currentScene], this.scene = {
                        step: this.scene.step + 1,
                        src: t.src,
                        srcChoice: t.srcChoice,
                        choice1: t.choice1,
                        choice2: t.choice2
                    }) : !1 === this.isChoice && (t = this.srcList["scene" + (this.scene.step + 1)], this.scene = {
                        step: this.scene.step + 1,
                        src: t.src,
                        srcChoice: t.srcChoice,
                        choice1: t.choice1,
        ...
        var a = o.exports;
        r.a.component("video-game", a), navigator.vendor && navigator.vendor.indexOf("Apple") > -1 && navigator.userAgent && -1 == navigator.userAgent.indexOf("CriOS") && -1 == navigator.userAgent.indexOf("FxiOS") || new r.a({
            el: "#video",
            components: {
                VideoGame: a
            }

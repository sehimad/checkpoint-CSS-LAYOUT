...
function scrollToY(t, e, i, n) {
    function o() {
        var e = (r += 1 / 60) / a,
            d = l[i](e);
        e < 1 ? (requestAnimationFrame(o), window.scrollTo(0, s + (t - s) * d)) : (n && n(), window.scrollTo(0, t))
    }
            ...
            if ("undefined" != typeof document) {
                ...
                for (var l = document.cookie ? document.cookie.split("; ") : [], d = /(%[0-9A-Z]{2})+/g, c = 0; c < l.length; c++) {
                    ...
                    try {
                        ...
                        if (h = i.read ? i.read(h, p) : i(h, p) || h.replace(d, decodeURIComponent), this.json) try {
                            h = JSON.parse(h)
                        } catch (t) {}
                        if (e === p) {
                            r = h;
...
function(t) {
    function e(t) {
        for (var e = (t += "").split("."), i = e[0], n = e.length > 1 ? "." + e[1] : "", o = /(\d+)(\d{3})/; o.test(i);) i = i.replace(o, "$1 $2");
        return i + n
    }
    t.fn.counterUp = function(i) {
        ...
        return this.each(function() {
            ...
            ! function() {
                ...
                i.data("counterup-nums", t), i.text("0"), i.data("counterup-func", function() {
                    i.text(e(i.data("counterup-nums").shift())), i.data("counterup-nums").length ? setTimeout(i.data("counterup-func"), o.delay) : (i.data("counterup-nums"), i.data("counterup-nums", null), i.data("counterup-func", null))
...
var isMobile = navigator.userAgent.match(/Android|AvantGo|BlackBerry|DoCoMo|Fennec|iPod|iPhone|iPad|J2ME|MIDP|NetFront|Nokia|Opera Mini|Opera Mobi|PalmOS|PalmSource|portalmmm|Plucker|ReqwirelessWeb|SonyEricsson|Symbian|UP\\.Browser|webOS|Windows CE|Windows Phone OS|Xiino/i),
    cssProp = function(t) {
        ...
        if (!i) {
            for (var a = 0; a < s; a++)
                if ("" == o[a] && (r = r.toLowerCase()), void 0 != n[o[a] + r]) return o[a] + r;
            i = !0
        }
    };
...
var loadScript = function(t) {
        var e, i;
        (e = document.createElement("script")).type = "text/javascript", e.src = t, (i = document.getElementsByTagName("script")[0]).parentNode.insertBefore(e, i)
    },
...
$jscomp.defineProperty = "function" == typeof Object.defineProperties ? Object.defineProperty : function(t, e, i) {
    ...
    function(t, e, i) {
        ...
        var e = function(e, i, n) {
            var o = {
                ...
                getCaret: function() {
                    try {
                        var t, i = 0,
                            ...
                            r = n.selectionStart;
                        return s && -1 === navigator.appVersion.indexOf("MSIE 10") ? ((t = s.createRange()).moveStart("character", -o.val().length), i = t.text.length) : (r || "0" === r) && (i = r), i
                    } catch (t) {}
                },
                setCaret: function(t) {
                    try {
                ...
                getRegexMask: function() {
                    for (var t, e, n, o, s = [], a = 0; a < i.length; a++)(t = r.translation[i.charAt(a)]) ? (e = t.pattern.toString().replace(/.{1}$|^.{1}/g, ""), n = t.optional, (t = t.recursive) ? (s.push(i.charAt(a)), o = {
                        digit: i.charAt(a),
                        pattern: e
                ...
                calculateCaretPosition: function() {
                    var t = e.data("mask-previus-value") || "",
                        ...
                        n = o.getCaret();
                    if (t !== i) {
                        var s, r = e.data("mask-previus-caret-pos") || 0,
                            i = i.length,
                            a = t.length,
                            l = t = 0,
                            d = 0,
                        ...
                        n > a ? n = i : r >= n && r !== a ? o.maskDigitPosMapOld[n] || (r = n, n = n - (c - d) - t, o.maskDigitPosMap[n] && (n = r)) : n > r && (n = n + (d - c) + l)
                    }
                    return n
                },
                behaviour: function(i) {
                    ...
                    if (-1 === t.inArray(n, r.byPassKeys)) {
                        ...
                        }, 10), o.val(n), o.setCaret(s), o.callbacks(i)
                    }
                },
                getMasked: function(t, e) {
                    var s, a, l = [],
                        ...
                        v = 0,
                        y = [];
                    n.reverse ? (m = "unshift", f = -1, s = 0, c = u - 1, h = p - 1, a = function() {
                        return -1 < c && -1 < h
                    }) : (s = u - 1, a = function() {
                        return c < u && h < p
                    });
                    for (var w; a();) {
                        var b = i.charAt(c),
                            k = d.charAt(h),
                            S = r.translation[b];
                        S ? (k.match(S.pattern) ? (l[m](k), S.recursive && (-1 === g ? g = c : c === s && (c = g - f), s === g && (c -= f)), c += f) : k === w ? (v--, w = void 0) : S.optional ? (c += f, h -= f) : S.fallback ? (l[m](S.fallback), c += f, h -= f) : o.invalid.push({
                            p: h,
                            v: k,
                            e: S.pattern
                        }), h += f) : (t || l[m](b), k === b ? (y.push(h), h += f) : (w = b, y.push(h + v), v++), c += f)
                    }
                    return d = i.charAt(s), u !== p + 1 || r.translation[d] || l.push(d), l = l.join(""), o.mapMaskdigitPositions(l, y, p), l
                },
                mapMaskdigitPositions: function(t, e, i) {
                    for (t = n.reverse ? t.length - i : 0, o.maskDigitPosMap = {}, i = 0; i < e.length; i++) o.maskDigitPosMap[e[i] + t] = 1
                },
                callbacks: function(t) {
                    ...
                    d("onChange", !0 === r, l), d("onKeyPress", !0 === r, l), d("onComplete", s.length === i.length, l), d("onInvalid", 0 < o.invalid.length, [s, t, e, o.invalid, n])
                }
            };
            e = t(e);
            var s, r = this,
            ...
            i = "function" == typeof i ? i(o.val(), void 0, e, n) : i, r.mask = i, r.options = n, r.remove = function() {
                ...
                if (a = a || !1, n = n || {}, r.clearIfNotMatch = t.jMaskGlobals.clearIfNotMatch, r.byPassKeys = t.jMaskGlobals.byPassKeys, r.translation = t.extend({}, t.jMaskGlobals.translation, n.translation), r = t.extend(!0, {}, r, n), s = o.getRegexMask(), a) o.events(), o.val(o.getMasked());
                    ...
                    n.placeholder && e.attr("placeholder", n.placeholder), e.data("mask") && e.attr("autocomplete", "off"), a = 0;
                    ...
                    l && e.attr("maxlength", i.length), o.destroyEvents(), o.events(), a = o.getCaret(), o.val(o.getMasked()), o.setCaret(a)
                }
            }, r.init(!e.is("input"))
        };
        t.maskWatchers = {};
        var i = function() {
            ...
            n = function(e, i, n) {
                ...
                e = t(e).val() || t(e).text();
                try {
                    return "function" == typeof i && (i = i(e)), "object" != typeof o || s(o.options) !== s(n) || o.mask !== i
                } catch (t) {}
            },
            o = function(t) {
    ...
    function(t) {
        ...
        t.extend(t.fn, {
            ...
            rules: function(e, i) {
                ...
                if (e) switch (n = t.data(d.form, "validator").settings, o = n.rules, s = t.validator.staticRules(d), e) {
                    case "add":
            ...
            prototype: {
                ...
                element: function(e) {
                    var i = this.clean(e),
                        ...
                        o = !0;
                    return this.lastElement = n, void 0 === n ? delete this.invalid[i.name] : (this.prepareElement(n), this.currentElements = t(n), (o = !1 !== this.check(n)) ? delete this.invalid[n.name] : this.invalid[n.name] = !0), t(e).attr("aria-invalid", !o), this.numberOfInvalids() || (this.toHide = this.toHide.add(this.containers)), this.showErrors(), o
                },
            ...
            attributeRules: function(e) {
                ...
                for (i in t.validator.methods) "required" === i ? ("" === (n = e.getAttribute(i)) && (n = !0), n = !!n) : n = s.attr(i), /min|max/.test(i) && (null === r || /number|range|text/.test(r)) && (n = Number(n)), n || 0 === n ? o[i] = n : r === i && "range" !== r && (o[i] = !0);
                return o.maxlength && /-1|2147483647|524288/.test(o.maxlength) && delete o.maxlength, o
            },
            dataRules: function(e) {
                var i, n, o = {},
                    s = t(e);
                for (i in t.validator.methods) void 0 !== (n = s.data("rule" + i.charAt(0).toUpperCase() + i.substring(1).toLowerCase())) && (o[i] = n);
                return o
            },
            ...
            methods: {
                ...
                creditcard: function(t, e) {
                    ...
                    for (i = t.length - 1; i >= 0; i--) n = t.charAt(i), s = parseInt(n, 10), r && (s *= 2) > 9 && (s -= 9), o += s, r = !r;
                    return o % 10 == 0
                },
                ...
                remote: function(e, i, n) {
                    ...
                    return this.settings.messages[i.name] || (this.settings.messages[i.name] = {}), r.originalMessage = this.settings.messages[i.name].remote, this.settings.messages[i.name].remote = r.message, n = "string" == typeof n && {
                        url: n
                    } || n, r.old === e ? r.valid : (r.old = e, o = this, this.startRequest(i), s = {}, s[i.name] = e, t.ajax(t.extend(!0, {
                        url: n,
                        mode: "abort",
                        ...
                        success: function(n) {
                            ...
                            o.settings.messages[i.name].remote = r.originalMessage, d ? (l = o.formSubmitted, o.prepareElement(i), o.formSubmitted = l, o.successList.push(i), delete o.invalid[i.name], o.showErrors()) : (s = {}, a = n || o.defaultMessage(i, "remote"), s[i.name] = r.message = t.isFunction(a) ? a(e) : a, o.invalid[i.name] = !0, o.showErrors(s)), r.valid = d, o.stopRequest(i, d)
                        }
                    }, n)), "pending")
                }
            }
        ...
        e.prototype.add = function(t) {
            ...
            for (var s in t) {
                ...
                for (var a in this.waypoints[s]) {
                    var l, d, c, u, h, p = this.waypoints[s][a],
                        f = p.options.offset,
                        m = p.triggerPoint,
                        g = 0,
                        v = null == m;
                    p.element !== p.element.window && (g = p.adapter.offset()[r.offsetProp]), "function" == typeof f ? f = f.apply(p) : "string" == typeof f && (f = parseFloat(f), p.options.offset.indexOf("%") > -1 && (f = Math.ceil(r.contextDimension * f / 100))), l = r.contextScroll - r.contextOffset, p.triggerPoint = Math.floor(g + l - f), d = m < r.oldScroll, c = p.triggerPoint >= r.oldScroll, u = d && c, h = !d && !c, !v && u ? (p.queueTrigger(r.backward), n[p.group.id] = p.group) : !v && h ? (p.queueTrigger(r.forward), n[p.group.id] = p.group) : v && r.oldScroll >= p.triggerPoint && (p.queueTrigger(r.forward), n[p.group.id] = p.group)
                }
            }
    ...
    function(t, e) {
        ...
        return function() {
            ...
            function n(t) {
                p || (p = t), m = d(f = t - p, r, u, h), window.scrollTo(0, m), f < h ? window.requestAnimationFrame(n) : o()
            }

            function o() {
                window.scrollTo(0, r + u), s && c && (s.setAttribute("tabindex", "-1"), s.focus()), "function" == typeof g && g(), p = !1
            }
            var s = void 0,
                r = void 0,
                a = void 0,
            ...
            return function(o) {
                ...
                switch (h = p.duration || 1e3, l = p.offset || 0, g = p.callback, d = p.easing || easeInOutQuad, c = p.a11y || !1, r = e(), void 0 === o ? "undefined" : t(o)) {
                    case "number":
                        s = void 0, c = !1, a = r + o;
                        break;
                    case "object":
    ...
    function(t, e) {
        ...
        function o(o) {
            if (n(), "string" == typeof o && (o = document.querySelector(o)), o && "object" == typeof o && o.nodeType) {
                ...
                var T = t(r.height);
                return !1 !== T && (d.height = T + (k ? 0 : g + b)), d.innerWidth = d.width - (m + w), d.innerHeight = d.height - (g + b), d.outerWidth = d.width + v, d.outerHeight = d.height + y, d
            }
        }
    ...
    function(t, e) {
        ...
        return n._resetLayout = function() {
            ...
            for (var o = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](n, t), s = {
                    ...
                    y: o.y
                }, r = o.y + t.size.outerHeight, a = n + o.col, l = o.col; a > l; l++) this.colYs[l] = r;
            return s
            ...
            for (var l = (this._getOption("originTop") ? n.top : n.bottom) + i.outerHeight, d = r; a >= d; d++) this.colYs[d] = Math.max(l, this.colYs[d])
    ...
    function(t, e, i) {
        function n(i) {
            if (o = e.documentElement, s = e.body, q(), ot = this, i = i || {}, dt = i.constants || {}, i.easing)
                for (var n in i.easing) V[n] = i.easing[n];
            gt = i.edgeStrategy || "set", at = {
                beforerender: i.beforerender,
                render: i.render,
                keyframe: i.keyframe
            }, (lt = !1 !== i.forceHeight) && (Ot = i.scale || 1), ct = i.mobileDeceleration || T, ht = !1 !== i.smoothScrolling, pt = i.smoothScrollingDuration || C, ft = {
            ...
            })()) ? ((rt = e.getElementById(i.skrollrBody || x)) && nt(), U(), Et(o, [y, k], [w])) : Et(o, [y, b], [w]), ot.refresh(), wt(t, "resize orientationchange", function() {
                var t = o.clientWidth,
                    e = o.clientHeight;
        ...
        n.prototype.refresh = function(t) {
            var n, o, s = !1;
            for (t === i ? (s = !0, st = [], Wt = 0, t = e.getElementsByTagName("*")) : t.length === i && (t = [t]), n = 0, o = t.length; o > n; n++) {
                var r = t[n],
                    a = r,
                    l = [],
                    d = ht,
                ...
                if (s && $ in r && delete r[$], r.attributes) {
                                ...
                                if ("data-edge-strategy" !== m.name)
                                    if ("data-emit-events" !== m.name) {
                                        ...
                                        if (null !== g) {
                                            ...
                                            var b = g[3],
                                                k = g[4] || b;
                                            b && "start" !== b && "end" !== b ? (v.mode = "relative", v.anchors = [b, k]) : (v.mode = "absolute", "end" === b ? v.isEnd = !0 : v.isPercentage || (v.offset = v.offset * Ot))
                                        }
                                    } else u = !0;
                        else c = m.value;
                        else d = "off" !== m.value;
                    ...
                    if (l.length) {
                        var S, T, x;
                        !s && $ in r ? (x = r[$], S = st[x].styleAttr, T = st[x].classAttr) : (x = r[$] = Wt++, S = r.style.cssText, T = At(r)), st[x] = {
                            element: r,
                            styleAttr: S,
                            classAttr: T,
                            anchorTarget: a,
            ...
            var n = o.clientHeight,
                ...
                r = s.top,
                a = s.bottom - s.top;
            return e === E ? r -= n : e === A && (r -= n / 2), i === E ? r += a : i === A && (r += a / 2), (r += ot.getScrollTop()) + .5 | 0
            ...
            }).topDiff || (ut.done && ut.done.call(ot, !1), ut = i), ot
            ...
            return mt = !0 === i, _t ? qt = l.min(l.max(e, 0), Mt) : t.scrollTo(0, e), ot
            ...
            o.style.overflow = s.style.overflow = "", o.style.height = s.style.height = "", rt && r.setStyle(rt, "transform", "none"), ot = i, rt = i, at = i, lt = i, Mt = 0, Ot = 1, dt = i, ct = i, It = "down", Lt = -1, Rt = 0, jt = 0, Ht = !1, ut = i, ht = i, pt = i, ft = i, mt = i, Wt = 0, gt = i, _t = !1, qt = 0, vt = i
        };
        var U = function() {
                ...
                wt(o, [c, u, h, p].join(" "), function(t) {
                    ...
                    switch (f = o.clientY, m = o.clientX, w = t.timeStamp, F.test(d.tagName) || t.preventDefault(), t.type) {
                        case c:
                            n && n.blur(), ot.stopAnimateTo(), n = d, r = g = f, a = m, y = w;
                            break;
                        case u:
                            F.test(d.tagName) && e.activeElement !== d && t.preventDefault(), v = f - g, k = w - b, ot.setScrollTop(qt - v, !0), g = f, b = w;
                            break;
                        default:
                        case h:
                        case p:
                            ...
                            var C = l.abs(x / ct),
                                ...
                                E = ot.getScrollTop() - A,
                                $ = 0;
                            E > Mt ? ($ = (Mt - E) / A, E = Mt) : 0 > E && ($ = -E / A, E = 0), C *= 1 - $, ot.animateTo(E + .5 | 0, {
                                easing: "outCubic",
                                duration: C
                            })
                    }
            ...
            G = function() {
                var t, e, i, n, s, r, a, d, c, u, h, p = o.clientHeight,
                    f = xt();
                for (d = 0, c = st.length; c > d; d++)
                    for (t = st[d], e = t.element, i = t.anchorTarget, n = t.keyFrames, s = 0, r = n.length; r > s; s++) a = n[s], u = a.offset, h = f[a.constant] || 0, a.frame = u, a.isPercentage && (u *= p, a.frame = u), "relative" === a.mode && (it(e), a.frame = ot.relativeToAbsolute(i, a.anchors[0], a.anchors[1]) - u, it(e, !0)), a.frame += h, lt && !a.isEnd && a.frame > Mt && (Mt = a.frame);
                for (Mt = l.max(Mt, Ct()), d = 0, c = st.length; c > d; d++) {
                    for (s = 0, r = (n = (t = st[d]).keyFrames).length; r > s; s++) a = n[s], h = f[a.constant] || 0, a.isEnd && (a.frame = Mt - a.offset + h);
                    t.keyFrames.sort(Pt)
                }
            },
            Y = function(t, e) {
                for (var i = 0, n = st.length; n > i; i++) {
                    ...
                    if (w || b) {
                        ...
                        switch (w ? (Et(d, [m], [v, g]), S && T > -1 && (St(d, p.eventType, It), l.lastFrameIndex = -1)) : (Et(d, [v], [m, g]), S && h > T && (St(d, y.eventType, It), l.lastFrameIndex = h)), l.edge = w ? -1 : 1, l.edgeStrategy) {
                            case "reset":
                                it(d);
                                continue;
                            case "ease":
                            ...
                            case "set":
                                var x = k.props;
                                for (o in x) a.call(x, o) && (s = et(x[o].value), 0 === o.indexOf("@") ? d.setAttribute(o.substr(1), s) : r.setStyle(d, o, s));
                                continue
                        }
                        ...
                        if (c >= u[C].frame && c <= u[C + 1].frame) {
                            ...
                            for (o in A.props)
                                if (a.call(A.props, o)) {
                                    ...
                                    $ = A.props[o].easing($), s = tt(A.props[o].value, E.props[o].value, $), s = et(s), 0 === o.indexOf("@") ? d.setAttribute(o.substr(1), s) : r.setStyle(d, o, s)
                                }
                            S && T !== C && ("down" === It ? St(d, A.eventType, It) : St(d, E.eventType, It), l.lastFrameIndex = C);
                            break
                        }
                }
            },
            Q = function() {
                Ht && (Ht = !1, Tt());
                var t, e, n = ot.getScrollTop(),
                    o = zt();
                if (ut ? (o >= ut.endTime ? (n = ut.targetTop, t = ut.done, ut = i) : (e = ut.easing((o - ut.startTime) / ut.duration), n = ut.startTop + e * ut.topDiff | 0), ot.setScrollTop(n, !0)) : mt || (ft.targetTop - n && (ft = {
                        startTop: Lt,
                        topDiff: n - Lt,
                        targetTop: n,
                        startTime: Dt,
                        endTime: Dt + pt
                    }), o <= ft.endTime && (e = V.sqrt((o - ft.startTime) / pt), n = ft.startTop + e * ft.topDiff | 0)), mt || Lt !== n) {
                    mt = !1;
                    var s = {
                        curTop: n,
                        lastTop: Lt,
                    ...
                    !1 !== (at.beforerender && at.beforerender.call(ot, s)) && (Y(n, ot.getScrollTop()), _t && rt && r.setStyle(rt, "transform", "translate(0, " + -qt + "px) " + vt), Lt = n, at.render && at.render.call(ot, s)), t && t.call(ot, !1)
                }
                Dt = o
            },
            X = function(t) {
                for (var e = 0, i = t.keyFrames.length; i > e; e++) {
                    for (var n, o, s, r, a = t.keyFrames[e], l = {}; null !== (r = M.exec(a.props));) s = r[1], o = r[2], null !== (n = s.match(O)) ? (s = n[1], n = n[2]) : n = S, o = o.indexOf("!") ? Z(o) : [o.slice(1)], l[s] = {
                        value: o,
                        easing: V[n]
                    };
                    a.props = l
            ...
            Z = function(t) {
                ...
                }), _ && (H.lastIndex = 0, t = t.replace(H, function(t) {
                    return _ + t
            ...
            et = function(t) {
                var e = 1;
                return R.lastIndex = 0, t[0].replace(R, function() {
                    return t[e++]
                })
            },
            it = function(t, e) {
                for (var i, n, o = 0, s = (t = [].concat(t)).length; s > o; o++) n = t[o], (i = st[n[$]]) && (e ? (n.style.cssText = i.dirtyStyleAttr, Et(n, i.dirtyClassAttr)) : (i.dirtyStyleAttr = n.style.cssText, i.dirtyClassAttr = At(n), n.style.cssText = i.styleAttr, Et(n, i.classAttr)))
            },
            nt = function() {
        ...
        r.setStyle = function(t, e, i) {
            var n = t.style;
            if ("zIndex" === (e = e.replace(I, L).replace("-", ""))) isNaN(i) ? n[e] = i : n[e] = "" + (0 | i);
        ...
        var ot, st, rt, at, lt, dt, ct, ut, ht, pt, ft, mt, gt, vt, yt, wt = r.addEvent = function(e, i, n) {
                for (var o, s = 0, r = (i = i.split(" ")).length; r > s; s++) o = i[s], e.addEventListener ? e.addEventListener(o, n, !1) : e.attachEvent("on" + o, function(e) {
            ...
            kt = function() {
                for (var t, e = 0, i = Nt.length; i > e; e++) t = Nt[e], bt(t.element, t.name, t.listener);
                Nt = []
            },
            St = function(t, e, i) {
            ...
            Tt = function() {
                ...
                Mt = 0, lt && !_t && (s.style.height = ""), G(), lt && !_t && (s.style.height = Mt + o.clientHeight + "px"), _t ? ot.setScrollTop(l.min(ot.getScrollTop(), Mt)) : ot.setScrollTop(t, !0), mt = !0
            },
            xt = function() {
                var t, e, i = o.clientHeight,
                    n = {};
                for (t in dt) "function" == typeof(e = dt[t]) ? e = e.call(ot) : /p$/.test(e) && (e = e.slice(0, -1) / 100 * i), n[t] = e;
                return n
            },
            Ct = function() {
                var t = 0;
                return rt && (t = l.max(rt.offsetHeight, rt.scrollHeight)), l.max(t, s.scrollHeight, s.offsetHeight, o.scrollHeight, o.offsetHeight, o.clientHeight) - o.clientHeight
            },
            At = function(e) {
                var i = "className";
            ...
            Et = function(e, n, o) {
                ...
                if (t.SVGElement && e instanceof t.SVGElement && (e = e[s], s = "baseVal"), o !== i) {
                    for (var r = e[s], a = 0, l = o.length; l > a; a++) r = Ft(r).replace(Ft(o[a]), " ");
                    r = $t(r);
                    for (var d = 0, c = n.length; c > d; d++) - 1 === Ft(r).indexOf(Ft(n[d])) && (r += " " + n[d]);
                    e[s] = $t(r)
                } else e[s] = n
            },
            $t = function(t) {
    ...
    function(t) {
        ...
        (e = function() {
            ...
            var i, n, o, s = this;
            !0 === s.options.centerMode ? !0 === s.options.infinite ? (n = s.currentSlide + (s.options.slidesToShow / 2 + 1), o = n + s.options.slidesToShow + 2) : (n = Math.max(0, s.currentSlide - (s.options.slidesToShow / 2 + 1)), o = s.options.slidesToShow / 2 + 1 + 2 + s.currentSlide) : (n = s.options.infinite ? s.options.slidesToShow + s.currentSlide : s.currentSlide, o = Math.ceil(n + s.options.slidesToShow), !0 === s.options.fade && (n > 0 && n--, o <= s.slideCount && o++)), e(s.$slider.find(".slick-slide").slice(n, o)), s.slideCount <= s.options.slidesToShow ? (i = s.$slider.find(".slick-slide"), e(i)) : s.currentSlide >= s.slideCount - s.options.slidesToShow ? (i = s.$slider.find(".slick-cloned").slice(0, s.options.slidesToShow), e(i)) : 0 === s.currentSlide && (i = s.$slider.find(".slick-cloned").slice(-1 * s.options.slidesToShow), e(i))
    ...
    function() {
        ...
        function e(t, e, n) {
            i(), this.isReady = !1, this.setElement(t, e), this.setOptions(e), this.setCallback(n), this.isReady && this.init()
        }
        t.prototype.TYPES = ["line", "ellipse", "circle", "polygon", "polyline", "rect"], t.prototype.ATTR_WATCH = ["cx", "cy", "points", "r", "rx", "ry", "x", "x1", "x2", "y", "y1", "y2"], t.prototype.scan = function(t) {
            for (var e, i, n, o, s = t.querySelectorAll(this.TYPES.join(",")), r = 0; r < s.length; r++) i = s[r], e = this[i.tagName.toLowerCase() + "ToPath"], n = e(this.parseAttr(i.attributes)), o = this.pathMaker(i, n), i.parentNode.replaceChild(o, i)
            ...
            return e.d = "M" + i + " " + n + " ", e.d += "L" + (i + o) + " " + n + " ", e.d += "L" + (i + o) + " " + (n + s) + " ", e.d += "L" + i + " " + (n + s) + " Z", e
            ...
            for (i = "M" + o[0], e = 1; e < o.length; e++) - 1 !== o[e].indexOf(",") && (i += "L" + o[e]);
            return n.d = i, n
            ...
            var e = {},
                ...
                d = s;
            return e.d = "M" + r + "," + a + "A" + i + "," + n + " 0,1,1 " + l + "," + d + "A" + i + "," + n + " 0,1,1 " + r + "," + d, e
            ...
            for (i = 0; i < t.attributes.length; i++) n = t.attributes[i], -1 === this.ATTR_WATCH.indexOf(n.name) && o.setAttribute(n.name, n.value);
        ...
        e.LINEAR = function(t) {
            ...
            if (this.parentEl = t, e && e.file) {
                ...
                i.setAttribute("type", "image/svg+xml"), i.setAttribute("data", e.file), i.setAttribute("built-by-vivus", "true"), t.appendChild(i), t = i
            }
            ...
            if ((t = t || {}).type && -1 === i.indexOf(t.type)) throw new Error("Vivus [constructor]: " + t.type + " is not an existing animation `type`");
            if (this.type = t.type || i[0], t.start && -1 === n.indexOf(t.start)) throw new Error("Vivus [constructor]: " + t.start + " is not an existing `start` option");
            ...
            var t, e, i, n, o, r, a, l;
            for (l = r = a = 0, e = this.el.querySelectorAll("path"), t = 0; t < e.length; t++) i = e[t], this.isInvisible(i) || (o = {
                el: i,
                length: Math.ceil(i.getTotalLength())
            }, isNaN(o.length) ? window.console && console.warn : (this.map.push(o), i.style.strokeDasharray = o.length + " " + (o.length + 2 * this.dashGap), i.style.strokeDashoffset = o.length + this.dashGap, o.length += this.dashGap, r += o.length, this.renderPath(t)));
            for (r = 0 === r ? 1 : r, this.delay = null === this.delay ? this.duration / 3 : this.delay, this.delayUnit = this.delay / (e.length > 1 ? e.length - 1 : 1), this.reverseStack && this.map.reverse(), t = 0; t < this.map.length; t++) {
                switch (o = this.map[t], this.type) {
                    case "delayed":
                        o.startAt = this.delayUnit * t, o.duration = this.duration - this.delay;
                        break;
                    case "oneByOne":
                        o.startAt = a / r * this.duration, o.duration = o.length / r * this.duration;
                        break;
                    case "sync":
                    case "async":
                    case "nsync":
                        ...
                        break;
                    case "scenario-sync":
                        i = o.el, n = this.parseAttr(i), o.startAt = l + (s(n["data-delay"], this.delayUnit) || 0), o.duration = s(n["data-duration"], this.duration), l = void 0 !== n["data-async"] ? o.startAt : o.startAt + o.duration, this.frameLength = Math.max(this.frameLength, o.startAt + o.duration);
                        break;
                    case "scenario":
                        i = o.el, n = this.parseAttr(i), o.startAt = s(n["data-start"], this.delayUnit) || 0, o.duration = s(n["data-duration"], this.duration), this.frameLength = Math.max(this.frameLength, o.startAt + o.duration)
                }
                a += o.length, this.frameLength = this.frameLength || this.duration
            }
